...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    splashController = [[SplashViewController alloc] initWithNibName:@"SplashViewController" bundle:nil];
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.reviewthis.Reviewer" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Reviewer" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"Reviewer.sqlite"];
    NSError *error = nil;
...
-(void)splashReady
{
    ReviewThis *app = [ReviewThis sharedInstance];
    [app setAppType: AppReviewer];
...
- (void) startApp
{
    ReviewerTopicsViewController *topicsController = [[ReviewerTopicsViewController alloc] initWithNibName:@"ReviewerTopicsViewController" bundle:nil];
    //topicsController.delegate = self;
    [[AppDelegate rootController] pushViewController:topicsController animated:NO];
}
