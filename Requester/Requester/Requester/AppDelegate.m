...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.reviewthis.Requester" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Requester" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"Requester.sqlite"];
    NSError *error = nil;
...
- (void) startApp
{
    TopicsViewController *topicsController = [[TopicsViewController alloc] initWithNibName:@"TopicsViewController" bundle:nil];
